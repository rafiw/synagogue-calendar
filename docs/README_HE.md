...
- [תכונות (עברית)](./FEATURES_HE.md) 📖
- [תכונות (English)](./FEATURES.md) 📖
...
- 🕯️ **לוח זיכרון** - הצגת לוח הנצחה דיגיטלי עם אפשרות ייבוא מ-CSV
...
[👉 ראה את כל התכונות בפירוט (עברית)](./FEATURES_HE.md) | [English Features](./FEATURES.md)
