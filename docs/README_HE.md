...
![לוגו האפליקציה](./images/app-logo.png)
...
לוח שנה לבית הכנסת הוא אפליקציה מודרנית ועשירה בתכונות, שנועדה לעזור לבתי כנסת לנהל ולהציג את לוחות הזמנים היומיים, זמני תפילה, שיעורים, הודעות ומידע אודות נפטרים.

האפליקציה בנויה עם React Native ו-Expo, ופועלת בצורה חלקה על פלטפורמות Android, iOS ודפדפן אינטרנט.

![מסך ראשי](./images/main-screen.png)
...
- 🕯️ **לוח זיכרון** - מעקב אחר תאריכי יארצייט עם תמיכה בתמונות
...
- ☁️ **סנכרון ענן אופציונלי** - גיבוי GitHub Gist לסנכרון בין מכשירים
...
1. **הגדר מיקום** - קבע איזור זמן, קו רוחב, קו אורך לזמנים מדויקים
...
|            תצוגה ראשית            |              הגדרות              |             שיעורים              |
| :-------------------------------: | :------------------------------: | :------------------------------: |
| ![ראשי](./images/main-screen.png) | ![הגדרות](./images/settings.png) | ![שיעורים](./images/classes.png) |

|            לוח זיכרון            |          לוח תפילות           |            אפשרויות רקע            |
| :------------------------------: | :---------------------------: | :--------------------------------: |
| ![זיכרון](./images/memorial.png) | ![לוח](./images/schedule.png) | ![רקעים](./images/backgrounds.png) |
...
- Expo ~54.0
- TypeScript 5.9+
- NativeWind (Tailwind עבור React Native)
